...
using Bureaucratize.Templating.Infrastructure.EntityFramework.PersistenceModels;
using Bureaucratize.Templating.Infrastructure.EntityFramework.PersistenceModels.BaseModel;
using Microsoft.EntityFrameworkCore;
using TemplateDefintion = Bureaucratize.Templating.Core.Template.TemplateDefinition;

namespace Bureaucratize.Templating.Infrastructure.EntityFramework
{
