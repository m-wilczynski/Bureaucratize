...
namespace Bureaucratize.Web.Config
{
    public class ImageProcessingPersistenceConfiguration : IImageProcessingPersistenceConfiguration
    {
        ...
        public ImageProcessingPersistenceConfiguration(IConfiguration configuration)
        {
            if (configuration == null) throw new ArgumentNullException(nameof(configuration));
            _configuration = configuration;
        }

        public string DatabaseConnectionString => _configuration.GetConnectionString("ImageProcessingDb");
